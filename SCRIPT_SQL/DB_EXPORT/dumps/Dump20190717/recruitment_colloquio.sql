...
CREATE TABLE `colloquio` (
  `idcolloquio` int(11) NOT NULL AUTO_INCREMENT,
  `data` date NOT NULL,
  `ora` time NOT NULL,
  `stanza` int(11) NOT NULL,
  `esito_globale` varchar(50) NOT NULL,
  `note` varchar(70) DEFAULT NULL,
  `idesigenza` int(11) NOT NULL,
  `idcandidato` int(11) NOT NULL,
  PRIMARY KEY (`idcolloquio`),
  KEY `fk_esigenza_idx` (`idesigenza`),
  KEY `fk_candidato_idx` (`idcandidato`),
  CONSTRAINT `fk_candidato` FOREIGN KEY (`idcandidato`) REFERENCES `candidato` (`idcandidato`),
  CONSTRAINT `fk_esigenza` FOREIGN KEY (`idesigenza`) REFERENCES `esigenza` (`idesigenza`)
...
-- Dump completed on 2019-07-17 12:27:14
